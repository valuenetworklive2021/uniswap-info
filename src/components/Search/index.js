...
import { useAllPairsInValueswap, useAllTokensInValueswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInValueswap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInValueswap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search Valueswap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
